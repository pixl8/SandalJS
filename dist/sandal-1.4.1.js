...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jqnext')) :
  typeof define === 'function' && define.amd ? define(['jqnext'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Sandal = factory(global.$));
  ...
  // Data
  const getData = (el, key) => $(el).data(key);
  const setData = (el, key, value) => $(el).data(key, value);

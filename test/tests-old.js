...
QUnit.test('Modal show/hide methods', function(assert) {
    if (!$.fn.modal) {
        assert.ok(false, 'Modal plugin not available');
        return;
    }
...
QUnit.test('Dropdown toggle method', function(assert) {
    if (!$.fn.dropdown) {
        assert.ok(false, 'Dropdown plugin not available');
        return;
    }
...
QUnit.test('Tooltip show/hide methods', function(assert) {
    if (!$.fn.tooltip) {
        assert.ok(false, 'Tooltip plugin not available');
        return;
    }
...
QUnit.test('Bootstrap/SandalJS version', function(assert) {
    ...
    } else if ($.fn.modal.Constructor && $.fn.modal.Constructor.VERSION) {
